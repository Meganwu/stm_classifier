    ...
    def model_train(self,
        ...
        for episode in range(episodes):
            ...
            with open(os.path.join(self.output_dir, "train_output_episode.txt"), "a") as train_output_episode:
                train_output_episode.write(f"episode: {episode}, Episode_loss: {loss_episode_avg}, Episode_accuracy: {acc_episode}\n")
            if tensorboard:
            ...
            if episode%10==0:
                ...
                with open(os.path.join(self.output_dir, "val_output_episode.txt"), "a") as val_output_episode:
                    val_output_episode.write(f"episode: {episode}, Loss: {val_loss}, Accuracy: {val_acc}\n")
                if tensorboard:
