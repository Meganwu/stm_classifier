...
train_loader=torch.utils.data.DataLoader(train_dataset, batch_size=128, shuffle=shuffle, num_workers=0)
...
def func(X):
    ...
    output_dir='output_128_%s_%s%s%s' % (lr, current_time.day, current_time.hour, current_time.minute)
